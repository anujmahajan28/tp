...
I would like to refer Saloni Raj Singh as she has demonstrated strong technical skills, research ability, and adaptability throughout her journey. Currently pursuing Computer Science Engineering at MIT-WPU, she has gained practical industry exposure as a PLM Intern at Piterion India, where she automated workflows and developed scalable solutions for drone manufacturing. Her academic projects, including an AI-based image captioning system and a dynamic QR code generator, showcase innovation and problem-solving. With a research paper published in Springer LNNS and proven strengths in teamwork and communication, Saloni stands out as a well-rounded candidate ready to add value.
